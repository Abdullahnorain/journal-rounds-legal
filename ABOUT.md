...
- Understand complex research faster
...
- Keep up with evidence-based practice
- Organize research for morning reports or journal clubs

### Attending Physicians
- Stay updated in your field without email overload
- Follow journals you trust, all in one place
- Quickly review abstracts with AI summaries

### Researchers & PhD Students
- Track journals relevant to your research area
- Organize articles for literature reviews
- Follow emerging trends in your field

### Healthcare Professionals
- Stay informed about evidence-based practice
...
2. **Choose Your Journals:** Follow medical journals relevant to your interests
3. **Get Your Feed:** Receive a personalized feed of the latest articles
...
Use appropriate clinical systems for patient care documentation.

### ⚠️ Verify Before Clinical Use
AI-generated summaries are tools to assist with reading comprehension, not clinical guidance. Always:
- Read the full article before making clinical decisions
...
**Q: Is Journal Rounds free?**  
A: Yes! Core features are free forever. Premium ($3.99/month) includes unlimited AI summaries.

**Q: Where do articles come from?**  
A: All articles come from PubMed, the public medical literature database maintained by the U.S. National Library of Medicine.

**Q: Can I use Journal Rounds for patient care?**  
A: Journal Rounds is a research tool, not a clinical documentation system. Don't store patient information in the app.

**Q: Are AI summaries accurate?**  
A: AI summaries are generally accurate but should always be verified against the original article before clinical use.

**Q: Can I access full-text articles?**  
A: Journal Rounds provides abstracts from PubMed. For full-text access, you'll need journal subscriptions or institutional access.

**Q: How do I cancel my subscription?**  
A: Manage your subscription in your Apple Account Settings. Cancellation takes effect at the end of your billing period.

---

## Thank You

Thank you for using Journal Rounds. We're honored to support your professional development and commitment to staying current with medical research.

**Stay Curious. Stay Current. Journal Rounds.**
